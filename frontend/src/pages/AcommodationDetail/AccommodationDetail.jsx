...
const AccommodationDetail = () => {
  ...
  useEffect(() => {
    if (accommodation?.images.length > 0) {
      setSelectedImage(accommodation.images[0]);
    }
  }, [accommodation]);
  ...
  return (
    <Box
      sx={{
        ...
        mx: "auto",
        display: "flex",
        flexDirection: { xs: "column", md: "row" }, //  Linha em telas grandes, coluna em pequenas
        gap: 5,
      }}
    >
      ...
      >
        ...
        <Typography variant="body1" color="text.secondary">
          <strong>Localização:</strong> {accommodation.localization}
        </Typography>
            ...
            {accommodation.images.map((img, index) => (
              <Card
                ...
                sx={{
                  ...
                  height: 80,
                  cursor: "pointer",
                  border: selectedImage === img ? "2px solid #ff6f61" : "none",
                  transition: "0.3s",
                }}
        ...
        <Card sx={{ width: "100%", borderRadius: "8px", padding: 2, mt: 2, boxShadow: 2 }}>
          ...
          <Typography variant="body2">{accommodation.summary}</Typography>
        </Card>
        ...
        <Card sx={{ width: "100%", borderRadius: "8px", padding: 2, mt: 2, boxShadow: 2 }}>
         ...
         {/* 🔹 🔥 Adicionando TitleSubtitle e StaticCard na Coluna Esquerda 🔥 */}
    <TitleSubtitle
      title="Imóveis Semelhantes"
      subtitle="Confira imóveis que você pode gostar"
      titleVariant="h5"
      mdMargin="0.5rem" 
      
    />

    <StaticCard sliceCount={2} />
      ...
      >
        <Typography
          variant="h5"
          sx={{ padding: "1rem", fontWeight: "bold", color: "#ff6f61", alignSelf: "flex-end", marginBottom: "2rem" }}
        >
          R$ {accommodation.price} por noite
        </Typography>
        ...
        <Card sx={{ width: "100%", maxWidth: "100%", padding: 3, borderRadius: 2, boxShadow: 2 }}>
          ...
          <Typography variant="body2" sx={{ overflowWrap: "break-word", wordBreak: "break-word", flexShrink: 1 }}>
          ...
          <Stack spacing={2} sx={{ mt: 2 }}>
            ...
            <TextField label="Dúvidas" variant="outlined" fullWidth multiline rows={4} />
...
//       setSelectedImage(accommodation.img);
//     // } else {
//     //   setSelectedImage(accommodation.img[0]);
//     }
//   }, [accommodation]);
...
//       <Grid2 container spacing={2} maxWidth="70%" alignItems='flex-start'>
        
//         {/* 📌 Coluna Esquerda (Imagens e Informações) */}
//         <Grid2 item xs={12} md={7} sx={{ paddingLeft: 1, mx: 1, display: "flex", flexDirection: "column", gap: 2.5 }}>
//         {/* Nome e Localização */}
//           <Typography variant="h4" sx={{ fontWeight: "bold", marginBottom: "-10px" }}>
//             {accommodation.title}
//           </Typography>
...
//           {accommodation.img && (
//             <Stack direction="row" spacing={2} sx={{ overflowX: "auto", p: 1, mt: 2 }}>
//             {[accommodation.img].map((img, index) => (
//               <Card
//                 key={index}
//                 sx={{
//                   width: 80,
...
//                   transition: "0.3s",
//                 }}
//                 onClick={() => setSelectedImage(accommodation.img)}
//               >
//                 <CardMedia
//                   component="img"
